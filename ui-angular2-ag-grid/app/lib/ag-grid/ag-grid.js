    ...
    (function (grid) {
        ...
        var AgGridNg2 = (function () {
            function AgGridNg2(elementDef) {
                ...
                // core grid events
                this.modelUpdated = this.newEventEmitter();
                this.cellClicked = this.newEventEmitter();
                this.cellDoubleClicked = this.newEventEmitter();
                this.cellContextMenu = this.newEventEmitter();
                this.cellValueChanged = this.newEventEmitter();
                this.cellFocused = this.newEventEmitter();
                this.rowSelected = this.newEventEmitter();
                this.rowDeselected = this.newEventEmitter();
                this.selectionChanged = this.newEventEmitter();
                this.beforeFilterChanged = this.newEventEmitter();
                this.afterFilterChanged = this.newEventEmitter();
                this.filterModified = this.newEventEmitter();
                this.beforeSortChanged = this.newEventEmitter();
                this.afterSortChanged = this.newEventEmitter();
                this.virtualRowRemoved = this.newEventEmitter();
                this.rowClicked = this.newEventEmitter();
                this.rowDoubleClicked = this.newEventEmitter();
                this.ready = this.newEventEmitter();
                // column grid events
                this.columnEverythingChanged = this.newEventEmitter();
                this.columnPivotChanged = this.newEventEmitter();
                this.columnValueChanged = this.newEventEmitter();
                this.columnMoved = this.newEventEmitter();
                this.columnVisible = this.newEventEmitter();
                this.columnGroupOpened = this.newEventEmitter();
                this.columnResized = this.newEventEmitter();
                this.columnPinnedCountChanged = this.newEventEmitter();
            }
            ...
            AgGridNg2.prototype.newEventEmitter = function () {
                if (!!_ng.core) {
                    // after angular2 beta
        ...
        else if (window.ng && window.ng.core.Component) {
            var ng = window.ng;
            initialiseAgGridWithAngular2(ng);
        }
        // for backword compatibility
        function initialiseAgGridWithAngular2alpha(ng) {
            _ng = ng;
        ...
        grid.initialiseAgGridWithAngular2alpha = initialiseAgGridWithAngular2alpha;
